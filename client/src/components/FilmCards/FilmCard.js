    ...
    <div className='filmcard'>
      ...
      <div>
        ...
        <div className='film-card-info-details'>
          <span className='director'>
            <img src={Chair} className='film-info-icon' alt='img' />
            <b>{director}</b>
          </span>
          <span className='year'>
            <img src={Year} className='film-info-icon' alt='img' />
            <b>{year}</b>
          </span>
          <span className='Rating'>
            <img src={Rating} className='stars' alt='img' />:<b>{rating}</b>
          </span>
        </div>
        <p className='describe'>{shortDescription}</p>
        <div className='film-details'>
          <span className='hindi'>
            <img src={category} className='film-info-icon' alt='img' />
            {genre}
          </span>
          <span className='category'>
            <img src={hindi} className='film-info-icon' alt='img' />
            {language}
          </span>
        </div>
      </div>
      <div className='btn-row'>
        <div className='edit-btn'>
          <Button title="Edit" onClick={() => navigate(`/film/edit/${_id}`)} />
        </div>
